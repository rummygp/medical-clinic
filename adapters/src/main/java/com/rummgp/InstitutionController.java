...
public class InstitutionController {
    ...
    @GetMapping
    public PageDto<InstitutionDto> findAll(@ModelAttribute InstitutionFindRequestDto institutionFindRequestDto) {
        InstitutionFindCommand command = institutionMapper.toCommand(institutionFindRequestDto);
        return pageMapper.toDto(institutionService.findAll(command), institutionMapper::toDto);
    }
    ...
    public InstitutionDto add(@RequestBody InstitutionCreateCommand institution) {
        return institutionMapper.toDto(institutionService.add(institutionMapper.toPojo(institution)));
    }
}
